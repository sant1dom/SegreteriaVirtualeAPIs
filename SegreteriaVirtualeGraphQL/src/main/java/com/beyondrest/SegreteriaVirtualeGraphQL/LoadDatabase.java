...
import com.beyondrest.SegreteriaVirtualeGraphQL.pianodistudi.PianoDiStudiPrivatoRepository;
...
class LoadDatabase {
    ...
    private static void initializeMessaggi(MessaggioRepository messaggioRepository, DocenteRepository docenteRepository) {
        log.info("Preloading " + messaggioRepository.save(new Messaggio(1L, "Messaggio 1", "Testo messaggio 1", new Date(System.currentTimeMillis()), docenteRepository.findById(1L).orElseGet(Docente::new), null)));
        log.info("Preloading " + messaggioRepository.save(new Messaggio(2L, "Messaggio 2", "Testo messaggio 2", new Date(System.currentTimeMillis()), docenteRepository.findById(2L).orElseGet(Docente::new), null)));
        log.info("Preloading " + messaggioRepository.save(new Messaggio(3L, "Messaggio 3", "Testo messaggio 3", new Date(System.currentTimeMillis()), docenteRepository.findById(3L).orElseGet(Docente::new), null)));
        log.info("Preloading " + messaggioRepository.save(new Messaggio(4L, "Messaggio 4", "Testo messaggio 4", new Date(System.currentTimeMillis()), docenteRepository.findById(4L).orElseGet(Docente::new), null)));
    }
    ...
    private static void initializeInsegnamenti(InsegnamentoRepository insegnamentoRepository,
        ...
        var insegnamento2 = new Insegnamento("Analisi 2",
                ...
                "2024-2025",
                "Lunedì 10:00 - 12:00, Mercoledì 10:00 - 12:00");
        insegnamento2.setLezioni(List.of(lezioneRepository.findById(2L).orElseGet(Lezione::new)));
        ...
        var insegnamento3 = new Insegnamento("Fisica 1",
                ...
                "2024-2025",
                "Lunedì 10:00 - 12:00, Mercoledì 10:00 - 12:00");
        insegnamento3.setLezioni(List.of(lezioneRepository.findById(3L).orElseGet(Lezione::new)));
        ...
        var insegnamento4 = new Insegnamento("Fisica 2",
                ...
                "2024-2025",
                "Lunedì 10:00 - 12:00, Mercoledì 10:00 - 12:00");
        insegnamento4.setLezioni(List.of(lezioneRepository.findById(4L).orElseGet(Lezione::new)));
